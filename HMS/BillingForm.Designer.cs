namespace HMS
{
    partial class BillingForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            colService = new DataGridViewComboBoxColumn(); // Changed to ComboBoxColumn
            ...
            // colService (Updated to Dropdown)
            colService.HeaderText = "Service Description";
            colService.Items.AddRange(new object[] {
            "Emergency Bill",
            "OPD Bill (Out Patient Department)",
            "IPD Bill (In Patient Department)",
            "Consultation Bill",
            "Surgery Bill",
            "Laboratory Bill",
            "X-Ray",
            ...
            txtTax.Name = "txtTax";
            txtTax.ReadOnly = true; // Made read-only so users can't override the 18%
            ...
            lblDiscount.Text = "Discount (5%):";

            // txtDiscount
            txtDiscount.Location = new Point(570, 470);
            txtDiscount.Name = "txtDiscount";
            txtDiscount.ReadOnly = true; // Made read-only so users can't override the 5%
